...
def MainMethodA(bpInputFile,cores,quiet,email,force,verbose):
    ...
    #changes them to -1 to be re-ran
        ...
        ReCreateCP(checkpoint_file,bpInputFile,quiet,sim_list,dest_folder,email,force)
...
def ReCreateCP(checkpoint_file,input_file,quiet,sims,folder_name,email,force):
                    ...
                    if l[1] == '0':
                        ...
                        with h5py.File(folder_name + '.bpa', "a") as master:
                            ...
                            if group_name in master:
                                if quiet == False:
                                    print("Deleting",group_name,"from BPL file...")
    ...
    while True:
        ...
        with h5py.File(h5_file, 'a') as Master:
            ...
            if group_name not in Master:
                ...
                data = GatherData(data,system_name, body_list, log_file, in_files,vplanet_help, folder,verbose)
                CreateHDF5Group(data,vplanet_help,Master,verbose,group_name,archive= True)
