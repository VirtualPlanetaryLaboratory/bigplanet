...
has the extension ``.bpa``. As a bigplanet archive conatains *all* the data from your parameter sweep, you can safely delete
...
file and 10s of seconds to build a bigplanet file. The advantage``bigplanet`` is
...
publication-worthy figures in a fraction of the time required for the standard approach of opening each
relevant file to extract a single parameter from each simulation.
